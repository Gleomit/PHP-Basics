...
function init() {
    document.getElementById('removeLanguage').onclick = dynamicRemoveLang;
    document.getElementById('addLanguage').onclick = dynamicAddLang;
    document.getElementById('removeLanguageComputer').onclick = dynamicRemoveComputerLang;
    document.getElementById('addLanguageComputer').onclick = dynamicAddComputerLang;
}

function dynamicRemoveComputerLang() {
...
function dynamicAddComputerLang() {
